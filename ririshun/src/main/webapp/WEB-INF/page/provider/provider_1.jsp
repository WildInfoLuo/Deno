	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			...
			{field:'ck',checkbox:true,
				 ...
				 {field:'provider_name',title:'名称',align:'center',sortable:true,width:100,
					formatter:function(value,row,index){
	...
	*/
	...
	function initTree(){
		...
		var row = $("#datagrid").datagrid("getSelected");
		 ...
		 //获取用户当前资源
		$.ajax({
			url: '/ririshun/menu/menuByRole?id='+row.id,   
			type:"POST",
    ...
    <div class="ToolTip_Form" id="table_loginInfoEdit" onkeydown="if(event.keyCode==13){loginInfoEdit();}">  
        ...
        <ul>  
            <li>  
            	<div class=oneline>
            		<div class="item100">
            			<div class="itemleft50"> 角色名称： </div>
                		<div class="righttext" ><input type="text" class="easyui-validatebox" id="roleName" name="roleName" maxlength="20" required="true"></input>  </div>
              		</div>
              </div>  
            </li> 
 			<li>  
            	<div class=oneline>
            		<div class="item100">
            			<div class="itemleft50"> 关联资源： </div>
                		<div class="righttext" >
						<select  name="resourceIds2" id="resourceIds2"></select>	         
						<input type="hidden" id="resourceIdup"  name="resourceId"/>       		
                		  </div>
              		</div>
              </div>  
            </li>  
