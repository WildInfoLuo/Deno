	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			...
			{field:'ck',checkbox:true,
				 ...
				 {field:'project_name',title:'名称',align:'center',sortable:true,width:100,
					formatter:function(value,row,index){
				...
				{field:'action',title:'抽取',align:'center',sortable:true,width:100,
					formatter:function(value,row,index){
						var orderId = row.id;
						var d = '<a href="#" onclick="edit(\'' +orderId+ '\')">抽&nbsp;取</a>';
						 return  d;
					}}	 
			 ] ],
		...
		updateDialog = $('#update_div').show().dialog({
			...
			buttons : [ {
				...
				handler : function() {
					...
					$.messager.confirm('请确认', '您确认进行抽取吗', function(r) {
						if (r) {
							...
							$.ajax({
								...
								dataType : 'json',
								success : function(response) {
									$.messager.alert('提示:','成功抽取供应商'+response,'success'); 
...
<div class="easyui-layout"   data-options="fit:true" > 
 <div region="north" border="false" collapsible="true" collapsed="false"   title="查询条件" style="height:90px; overflow: auto;">
	...
	<td>项目修改时间:</td>
	<td><input id="startTimeQuery" name="startTimeQueryS"  class="easyui-datebox" style="width:150px;border:1px solid #D6D3D6;"></td>
	<td>到:</td>
	<td><input id="endTimeQuery" name="endTimeQueryS" class="easyui-datebox" style="width:150px;border:1px solid #D6D3D6;"></td>
...
<!-- 	</div> -->
    ...
    <div class="ToolTip_Form" id="table_loginInfoEdit" onkeydown="if(event.keyCode==13){loginInfoEdit();}">  
        <input  type="hidden"  id="updids" ></input>
        <ul>  
            <li>  
            	<div class=oneline>
            		<div class="item100">
 			...
 			<li>  
            	<div class=oneline>
            		<div class="item100">
            			<div class="itemleft50"> 请选择将要抽取的 项目供应商: </div>
                		<div class="righttext" >
